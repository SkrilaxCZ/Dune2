 ...
 */
void Tile_RefreshFogInRadius(tile32 tile, uint16 radius, bool unveil)
{
	uint16 packed;
	uint16 x, y;
	int16 i, j;
...
tile32 Tile_MoveByDirectionUnlimited(tile32 tile, int16 orientation, uint16 distance)
{
	int diffX, diffY;
