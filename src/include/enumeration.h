...
ENUM_MATH_OPERATORS(StructureType)
...
enum UnitFlag
{
	...
	/* Custom units */
	FLAG_UNIT_SARDAUKAR = 1 << UNIT_SARDAUKAR, /* 0x08______ */

	FLAG_UNIT_NONE = 0
};

ENUM_FLAG_OPERATORS(UnitFlag)
...
ENUM_MATH_OPERATORS(UnitActionType)

typedef UnitActionType ActionType;
