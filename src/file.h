...
extern FILE* File_Open_CaseInsensitive(SearchDirectory dir, const char* filename, const char* mode);
...
extern bool File_Exists_Ex(SearchDirectory dir, const char* filename);
extern uint8 File_Open_Ex(SearchDirectory dir, const char* filename, uint8 mode);
extern uint32 File_ReadBlockFile_Ex(SearchDirectory dir, const char* filename, void* buffer, uint32 length);
extern void* File_ReadWholeFile_Ex(SearchDirectory dir, const char* filename);
extern uint32 File_ReadFile_Ex(SearchDirectory dir, const char* filename, void* buf);
extern uint8 ChunkFile_Open_Ex(SearchDirectory dir, const char* filename);
