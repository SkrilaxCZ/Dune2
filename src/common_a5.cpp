...
static ScreenDivID curr_transform;

/*--------------------------------------------------------------*/

static void
A5_InitScreenDiv(ALLEGRO_BITMAP* parent, ScreenDivID divID,
...
void A5_Uninit()
{
	...
	for (ScreenDivID div = SCREENDIV_MAIN + 1; div < SCREENDIV_MAX; div++)
	{
