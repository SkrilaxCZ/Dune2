...
uint16
Tools_AdjustToGameSpeed(uint16 normal, uint16 minimum, uint16 maximum, bool inverseSpeed)
{
	UNUSED(minimum);
	UNUSED(maximum);
	UNUSED(inverseSpeed);
...
double Timer_GetUnitMovementFrame()
{
...
double Timer_GetUnitRotationFrame()
{
