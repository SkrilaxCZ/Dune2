...
static void Slider_Draw(Widget* w)
{
...
Widget* Slider_Allocate(uint16 index, uint16 parentID, uint16 offsetX, uint16 offsetY, int16 width, int16 height)
{
