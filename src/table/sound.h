...
struct Feedback
{
	SampleID voiceId[NUM_SPEECH_PARTS];
...
extern const SampleID g_table_voiceMapping[SOUNDID_MAX];
extern const Feedback g_feedback[VOICEID_MAX];
extern const SampleID g_translatedVoice[VOICEID_MAX][NUM_SPEECH_PARTS];
